...
data <- read.csv(file="oii_3726.csv", header=TRUE, sep=',')

setwd("~/Documents/MSc Astronomy/2018-2019/Astronomical Data Science/mandatory_tasks/project/data/oii_3726/n=2")
